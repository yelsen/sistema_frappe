...
<body>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="mb-3 position-relative">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="number" id="txtCantidad" class="form-control" min="0">

                                                        <a id="btnAñadir" class="btn btn-primary"><i class="fas fa-plus-circle"></i> Agregar</a>
                                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" id="txtMonto_total" class="form-control" style="background-color:rgb(9, 255, 0)" placeholder="0.00" readonly>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="number" id="txtPagar" class="form-control" placeholder="0.00" step="0.01" min="0">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" id="txtVuelto" class="form-control" placeholder="0.00" readonly>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="card-body">
                                <div class="page-header ">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-auto text-end float-end ms-auto download-grp">
                                            <button type="button" title="Reporte" class="btn btn-primary w-100" data-bs-toggle="modal"
                                                data-bs-target="#modalAgregar" id="bntReporte">Reporte</button>
                                        </div>
                                    </div>
                                </div>
    ...
    <script src="../controlador/JSventa.js"></script>
