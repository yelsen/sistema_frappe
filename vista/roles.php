...
<body>
                            ...
                            <div class="modal-body p-4">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            <label for="field-3" class="form-label">Roles</label>
                                            <input type="text" id="txtRolesE" class="form-control" placeholder="Roles">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="detalleRoles" class="form-control" readonly>
                                </div>
                            </div>
                            <div class="modal-footer">
    ...
    <script src="../controlador/JSroles.js"></script>
</body>
