...
<body>
                            ...
                            <div class="card-body">
                                ...
                                <div class="page-header ">
                                    <div class="row align-items-center">
                                        <div class="col">
                                            <h3 class="page-title">Gestión de Personales</h3>
                                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" id="cbRol" name="rol">
                            ...
                            <div class="modal-body p-4">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label class="form-label">Rol</label>
                                            <select class="form-select" id="cbRolE" style="height: 40px; font-size: 14px;">
    ...
    <script src="../controlador/JSpersonal.js"></script>
</body>
