...
<body>
                    ...
                    <ul>
                        ...
                        <li class="submenu active">
                            ...
                            <ul>
                                ...
                                <li><a class="active" href="tipo_comprobante.php">Tipos de Comprobantes</a></li>
            ...
            <div class="content container-fluid">
                            ...
                            <div class="card-body">
                                ...
                                <div class="page-header ">
                                    <div class="row align-items-center">
                                        <div class="col">
                                            <h3 class="page-title">Gestión de Tipo de Comprobantes</h3>
                                        </div>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 class="modal-title">Registro de Tipo de Comprobantes</h4>
                            ...
                            <div class="modal-body p-4">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            <label for="field-3" class="form-label">Tipo de Comprobante</label>
                                            <input type="text" id="txtTipo_comprobante" class="form-control" placeholder="Tipo de Comprobante">
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="modal fade" id="modalEditar" tabindex="-1" data-bs-backdrop="static" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 class="modal-title">Editar Tipo de Comprobantes</h4>
                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Cerrar"></button>
                            </div>
                            <div class="modal-body p-4">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            <label for="field-3" class="form-label">Tipo de Comprobante</label>
                                            <input type="text" id="txtTipo_comprobanteE" class="form-control" placeholder="Tipo de Comprobante">
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="mb-3">
                                    <label for="detalleTipo" class="form-label">Tipo de Comprobante:</label>
                                    <input type="text" id="detalleTipo" class="form-control" readonly>
                                </div>
                            </div>
                            <div class="modal-footer">
    ...
    <script src="../controlador/JStipo_comprobante.js"></script>
</body>
