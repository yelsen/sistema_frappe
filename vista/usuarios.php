                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3 position-relative">
                                            ...
                                            <div class="input-group">
                                                <input type="text" id="txtDNI" class="form-control" placeholder="Buscar por DNI o Nombres" autocomplete="off">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="mb-3 position-relative">
                                            <label class="form-label">Buscar Persona</label>
                                            <div class="input-group">
                                                <input type="text" id="txtDNIE" class="form-control" placeholder="Buscar por RUC o Nombres de Empresas" autocomplete="off" readonly>
                                                <a class="btn btn-primary"><i class="fas fa-search"></i></a>
                                            </div>
