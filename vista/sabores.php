...
<body>
                    ...
                    <ul>
                        ...
                        <li class="submenu active">
                            ...
                            <ul>
                                ...
                                <li><a class="active" href="sabores.php">Sabores</a></li>
            ...
            <div class="content container-fluid">
                            ...
                            <div class="card-body">
                                ...
                                <div class="page-header ">
                                    <div class="row align-items-center">
                                        <div class="col">
                                            <h3 class="page-title">Gestión de Sabores</h3>
                                        </div>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 class="modal-title">Registro de Sabores</h4>
                            ...
                            <div class="modal-body p-4">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            <label for="field-3" class="form-label">Sabores</label>
                                            <input type="text" id="txtSabores" class="form-control" placeholder="Sabores">
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="modal fade" id="modalEditar" tabindex="-1" data-bs-backdrop="static" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 class="modal-title">Editar Sabores</h4>
                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Cerrar"></button>
                            </div>
                            <div class="modal-body p-4">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            <label for="field-3" class="form-label">Sabores</label>
                                            <input type="text" id="txtSaboresE" class="form-control" placeholder="Sabores">
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="mb-3">
                                    <label for="detalleRol" class="form-label">Sabores</label>
                                    <input type="text" id="detalleSabores" class="form-control" readonly>
                                </div>
                            </div>
                            <div class="modal-footer">
    ...
    <script src="../controlador/JSsabores.js"></script>
</body>
