...
<body>
                    ...
                    <ul>
                        ...
                        <li class="submenu active">
                            ...
                            <ul>
                                ...
                                <li><a class="active" href="presentaciones.php">Presentaciones</a></li>
                            </ul>
                        </li>
                            ...
                            <div class="card-body">
                                ...
                                <div class="page-header ">
                                    <div class="row align-items-center">
                                        <div class="col">
                                            <h3 class="page-title">Gestión de Presentaciones</h3>
                                        </div>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 class="modal-title">Registro de Presentaciones</h4>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" id="txtPresentaciones" class="form-control" placeholder="Roles">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="modal-body p-4">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            <label for="field-3" class="form-label">Roles</label>
                                            <input type="text" id="txtPresentacionesE" class="form-control" placeholder="Roles">
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="mb-3">
                                    <label for="detalleRol" class="form-label">Roles</label>
                                    <input type="text" id="detallePresentaciones" class="form-control" readonly>
                                </div>
                            </div>
                            <div class="modal-footer">
    ...
    <script src="../controlador/JSpresentaciones.js"></script>
</body>
